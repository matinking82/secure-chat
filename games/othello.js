...
exports.parseOthello = parseOthello;
exports.serializeOthello = serializeOthello;
exports.othelloGetValidMoves = othelloGetValidMoves;
exports.othelloMakeMove = othelloMakeMove;
const SIZE = 8;
const EMPTY = 0;
const BLACK = 1;
const WHITE = 2;
function parseOthello(text) {
    if (!text.startsWith("GAME::OTHELLO::"))
        return null;
...
function othelloGetValidMoves(board, player) {
    const moves = [];
    for (let r = 0; r < SIZE; r++) {
        for (let c = 0; c < SIZE; c++) {
...
function othelloMakeMove(state, row, col, playerNum) {
    if (state.winner !== 0)
        return null;
